...
private:
    ...
    {
        // Ф26e full isolation: a ferry (KCTX_STORAGE) completion met on the
        // way is kept for the ferry station inside result_pop_any, so
        // result_any never steals a box::ferry's reply — mirroring
        // result_wait_any, the _S_block twin.
