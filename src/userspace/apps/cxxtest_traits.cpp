...
static_assert(strong_order(kNNan, -kInfD) < 0);
static_assert(strong_order(kInfD, kPNan) < 0);
static_assert(strong_order(kNNan, kPNan) < 0);
static_assert(strong_order(kPNan, kPNan2) < 0);
static_assert(strong_order(kPNan, kPNan) == 0);
static_assert(weak_order(-0.0, +0.0) == 0 && weak_order(-0.0f, +0.0f) == 0);
static_assert(weak_order(kPNan, kPNan2) == 0);
...
static_assert(strong_order(kInfL, __builtin_nanl("")) < 0);
static_assert(strong_order(-__builtin_nanl(""), -kInfL) < 0);
static_assert(strong_order(__LDBL_MIN__, 1.0L) < 0);
static_assert(strong_order(__LDBL_DENORM_MIN__, __LDBL_MIN__) < 0);
static_assert(weak_order(-0.0L, +0.0L) == 0);
static_assert(weak_order(1.0L, 2.0L) < 0 && weak_order(2.0L, 1.0L) > 0 && weak_order(1.0L, 1.0L) == 0);
static_assert(weak_order(__builtin_nanl(""), __builtin_nanl("")) == 0);
...
static_assert(compare_strong_order_fallback(-0.0L, +0.0L) < 0);
static_assert(compare_weak_order_fallback(-0.0L, +0.0L) == 0);
static_assert(compare_strong_order_fallback(-0.0, +0.0) < 0);
static_assert(compare_weak_order_fallback(kPNan, kPNan) == 0);
...
struct EmptyTag {};
static_assert(sizeof(tuple<EmptyTag, int>) == sizeof(int));
...
static_assert(rotl((unsigned __int128)1, 1) == (unsigned __int128)2);
static_assert(popcount((unsigned __int128)-1) == 128);
static_assert(byteswap((unsigned __int128)1) ==
              ((unsigned __int128)1 << 120));
