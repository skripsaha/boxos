...
static volatile uint64_t g_never;
static volatile uint64_t g_go;
static volatile uint64_t g_progress[NWORKERS + 1];
...
static volatile uint64_t g_woke;
...
static int brigade(void)
{
    ...
    error_t rc = addr_wake((void *)&g_word, 0);
...
int main(void)
{
    ...
    __atomic_store_n(&g_go, 1u, __ATOMIC_RELEASE);
    park_hammer(0);
